...
export const mainlineChrome = tv({
  slots: {
    ...
    title: "m-0 text-[0.88rem] font-semibold uppercase tracking-[0.08em] text-[#d8ebf8]",
    subtitle: "mt-1 text-[0.76rem] text-[#a9c4d6]",
    searchField: "mt-3 flex items-center gap-2 rounded-xl border border-[#86b6d24a] bg-[#0d2134bf] px-3 py-2",
    input:
    ...
    footerHint: "border-t border-[#8ab4cc2f] px-4 py-2 text-[0.68rem] tracking-[0.04em] text-[#8faac0]",
  },
})

export const commandItem = tv({
  base: "mb-1.5 flex w-full items-start justify-between gap-3 rounded-xl border border-transparent px-3 py-2 text-left outline-none transition-colors focus-visible:outline-2 focus-visible:outline-[#ffd89d]",
  variants: {
    active: {
      true: "border-[#ffd89d80] bg-[#1a3347]",
      false: "bg-[#0e2235b8] hover:bg-[#132c44]",
    },
    disabled: {
