...
export interface MainlineAdapter {
  ...
  loadChild: (pageId: string, itemId: string, query?: string, meta?: MainlineMeta) => Promise<MainlinePage | MainlineResult>
  execute: (itemId: string, pageId: string, query?: string, meta?: MainlineMeta) => Promise<MainlineResult>
  submit: (pageId: string, query: string, meta?: MainlineMeta) => Promise<MainlineResult>
...
export function createMainlineAdapter<T extends MainlineAdapter>(adapter: T): T {
  return adapter
}
