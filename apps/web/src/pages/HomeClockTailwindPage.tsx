...
import {
  enqueueKeyboardHelpToastOnce,
  keyboardHelpToastQueue,
  useKeyboardModality,
} from "./home-clock/keyboardHelpToast";
          ...
          {({ toast }) => (
            ...
            >
              <ToastContent className="grid gap-1">
                <Text
                  slot="title"
                  className="text-[0.86rem] font-semibold tracking-[0.02em] text-[#fff5e8]"
                >
                  {toast.content.title}
                </Text>
                <Text
                  slot="description"
                  className="text-[0.78rem] leading-[1.35] text-[#d8e9f6]"
                >
